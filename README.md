...
## Instructions
1. Players will be given a timer for each level ranging from 30 seconds on level 1 to 120 seconds on level 6.
...
## Level Three Page
![Level Three Page](src/assets/images/readmePictures/xlg123.github.io_Hey-Wake-Up-_%20(4).png)
